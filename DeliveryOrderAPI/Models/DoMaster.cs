...
public partial class DoMaster
{
    ...
    public string? PartCm { get; set; }

    public string? PartUnit { get; set; }

    public int? PartQtyBox { get; set; }

    public int? PartFixedDate { get; set; }

    public string? VdCode { get; set; }

    public string? VdName { get; set; }

    public int? VdProdLeadtime { get; set; }

    public int? VdRound { get; set; }

    public int? VdMinDelivery { get; set; }

    public int? VdMaxDelivery { get; set; }
